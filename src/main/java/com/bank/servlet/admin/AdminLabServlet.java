...
@WebServlet(name = "AdminLabServlet", urlPatterns = "/admin/lab")
public class AdminLabServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/admin/lab.jsp").forward(request, response);
    }
}
